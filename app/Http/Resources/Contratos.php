        ...
        $salida = [
            ...
            'data' => $this->collection->transform(function($c){
                return [
                    ...
                    "fechaContrato" => $c->fecha_contrato,
                    ...
                    "codigoUnidadMedida" => $c->id_unidad_medida,
                    ...
                    "fechaEntregaDesde" => $c->fecha_entrega_desde,
                    "fechaEntregaHasta" => $c->fecha_entrega_hasta,
                    "codigoCondicionPago" => $c->id_condicion_pago,
                    "codigoOpcionFijacion" => $c->id_opcion_fijacion,
                    "precio" => $c->precio,
                    "codigoMoneda" => $c->id_moneda,
                    "fechaConvenidaPago" => $c->fecha_convenida_pago,
                    ...
                    "fechaFijcionDesde" => $c->fecha_fijacion_desde,
                    "fechaFijacionHasta" => $c->fecha_fijacion_hasta,
